...
struct EditSpeciesSubView: View {
...
struct EditSpeciesSubView_Previews: PreviewProvider {
    static var previews: some View {
        EditSpeciesSubView(vm: DetailVM(), species: .constant("Salmon"))
    }
}
